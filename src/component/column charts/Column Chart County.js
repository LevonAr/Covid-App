...
class ColumnChartCounty extends PureComponent {
  ...
  componentDidMount() {
    ...
    fetch("https://raw.githubusercontent.com/LevonAr/Covid-19-data-JSON/master/update1_time_series/update2_fetch.json")
      .then((response) => {
      ...
      <div>
        ...
        <center>
            <div id="font" class="shadow p-3 mb-0 rounded bg-white border">
                Daily New Cases for all counties currently under development
            </div>
            <br></br>
        </center>


        <div class="shadow p-3 mb-0 rounded bg-white border" >
...
export default ColumnChartCounty;